...
Node *createNode(const char nim[],const char name[],int nilaiTugas, int nilaiQuiz, int nilaiUTS, int nilaiUAS) {
...
void pushQueue(const char nim[],const char name[],int nilaiTugas, int nilaiQuiz, int nilaiUTS, int nilaiUAS);
void removeQueue();
        ...
        do{  
            ...
            while(index != first) {  
                if(curr->nilaiAkhir > index->nilaiAkhir) {  
                    strcpy(tmp, curr->nim);
                    strcpy(curr->nim,index->nim);
                    strcpy(index->nim, tmp);
                    strcpy(tmp, curr->name);
                    strcpy(curr->name,index->name);
                    strcpy(index->name, tmp);
